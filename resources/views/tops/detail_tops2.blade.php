...
<main class="container my-5">
    <div class="detail row">
        ...
        <div class="col-md-6 text-center">
            <img src="{{ asset('img/tops2.jpg') }}" width="350px" height="450px" alt="Blouse Pleated Plum"
                class="img-fluid rounded">
        </div>
        <!-- Detail Produk -->
        <div class="col-md-6">
            <h2 class="fw-bold">Blouse Pleated Plum</h2>
            <p class="text-muted">Atasan dengan model menarik yang cocok kamu padankan dengan celana slim fit dan mules.
            </p>
            <p class="fs-4 text-danger">Rp.260.000</p>
            <!-- Ukuran -->
            <div class="mb-4">
                ...
                <div class="accordion-item" border="1">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            Ukuran: <br>
                            Lebar Bahu : 44 cm <br>
                            Lingkar Dada : 84 cm <br>
                            Panjang Tangan : 20 cm <br>
                            Lingkar Lengan : 36 cm <br>
                            Lingkar Pinggang : 44-104 cm <br>
                            Panjang : 63 cm 
                        </div>
                    </div>
                </div>
