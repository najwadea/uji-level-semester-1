...
<main class="container my-5">
    <div class="detail row">
        ...
        <div class="col-md-6 text-center">
            <img src="{{ asset('img/shoes3.jpg') }}" width="350px" height="450px" alt="Sofia Falaya Basic Heels Cream"
                class="img-fluid rounded">
        </div>
        <!-- Detail Produk -->
        <div class="col-md-6">
            <h2 class="fw-bold">Sofia Falaya Basic Heels Cream</h2>
            <p class="text-muted">Miliki heels dengan aksen transparan yang dapat kamu padankan dengan berbagai macam
                outfit favoritmu! </p>
                ...
                <div class="accordion-item" border="1">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            Ukuran : <br>
                            <br>
                            36: 23 cm , Lebar : 8,1 cm<br>
                            37: 23,5 cm , Lebar : 8,2 cm<br>
                            38: 24 cm , Lebar : 8,4 cm<br>
                            39: 24,5 cm , Lebar : 8,4 cm<br>
                            40: 25 cm , Lebar : 8,5 cm<br>
                            Hak: 5 cm
                        </div>
                    </div>
                </div>
