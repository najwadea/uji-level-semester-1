...
<main class="container my-5">
    <div class="detail row">
        ...
        <div class="col-md-6 text-center">
            <img src="{{ asset('img/dress2.jpg') }}" width="350px" height="450px" alt="Chic Asymmetric Black Dress"
                class="img-fluid rounded">
        </div>
        <!-- Detail Produk -->
        <div class="col-md-6">
            <h2 class="fw-bold">Chic Asymmetric Black Dress</h2>
            <p class="text-muted">Miliki dress yang cocok kamu padankan dengan berbagai macam sepatu dan aksesoris!</p>
            <p class="fs-4 text-danger">Rp.620.000</p>
            <!-- Ukuran -->
            <div class="mb-4">
                ...
                <div class="accordion-item" border="1">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            Ukuran: <br>
                            Lingkar Dada: 90-94 cm<br>
                            Lingkar Pinggang: 70-76 cm<br>
                            Panjang Dress: 85 cm<br>
                        </div>
                    </div>
                </div>
            </div>
