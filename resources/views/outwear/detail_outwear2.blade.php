...
<main class="container my-5">
    <div class="detail row">
        ...
        <div class="col-md-6 text-center">
            <img src="{{ asset('img/outwear2.jpg') }}" width="350px" height="450px" alt="Sofia Jenna Knit Cardigan Grey"
                class="img-fluid rounded">
        </div>
        <!-- Detail Produk -->
        <div class="col-md-6">
            <h2 class="fw-bold">Sofia Jenna Knit Cardigan Grey</h2>
            <p class="text-muted">Luaran dengan model menarik yang cocok dipadankan dengan dalaman tank top serta celana
                palazzo dan mules.</p>
            <p class="fs-4 text-danger">Rp.329.000</p>
            <!-- Ukuran -->
            <div class="mb-4">
