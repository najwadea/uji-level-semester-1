...
<main class="container my-5">
    <div class="detail row">
        ...
        <div class="col-md-6 text-center">
            <img src="{{ asset('img/outwear1.jpg') }}" width="350px" height="450px"
                alt="Sofia Mesha Pocket Blazer Brown" class="img-fluid rounded">
        </div>
        <!-- Detail Produk -->
        <div class="col-md-6">
            <h2 class="fw-bold">Sofia Mesha Pocket Blazer Brown</h2>
            <p class="text-muted">Luaran dengan model menarik yang cocok dipadankan dengan dalaman tank top serta celana
                palazzo dan mules.</p>
            <p class="fs-4 text-danger">Rp.142.000</p>
            <!-- Ukuran -->
            <div class="mb-4">
