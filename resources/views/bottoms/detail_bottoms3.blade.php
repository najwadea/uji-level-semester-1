...
<main class="container my-5">
    <div class="detail row">
        ...
        <div class="col-md-6 text-center">
            <img src="{{ asset('img/bottom3.jpg') }}" width="350px" height="450px"
                alt="Sofia Raelyn Tie Cargo Skirt Black" class="img-fluid rounded">
        </div>
        <!-- Detail Produk -->
        <div class="col-md-6">
            <h2 class="fw-bold">Sofia Raelyn Tie Cargo Skirt Black</h2>
